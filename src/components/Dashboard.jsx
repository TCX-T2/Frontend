  ...
  return (
    <div className="flex flex-col items-start justify-start w-full h-full gap-20 px-10 py-10">
      <div className="flex flex-col gap-20 w-full">
        <div>
          <h2 className="text-4xl font-semibold mt-10">Hi {nom}...</h2>
        ...
        <div className="flex justify-between items-center w-full">
          <div className="flex gap-5 items-center relative" id="search">
            ...
            <input
              type="text"
              name="recherche"
              className="p-3 rounded-xl bg-gray-50 w-96 pl-10 focus:outline-secondary border border-primary focus:ring-secondary focus:border-secondary"
